...
export function getDataFromBinary(binary) {
  return binary.data;
}
...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_SensorAppOverview .myCustomBackground_CSK_Module_SensorAppOverview { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_SensorAppOverview .myCustomBackground_CSK_Module_SensorAppOverview { background-color: #fff; }` // font-family: "sans-serif"; }`
